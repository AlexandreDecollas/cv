...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 11,
      vars: 1,
      consts: [["id", "introduction", 1, "page-section", "bg-primary"], [3, "alternateColor"], ["id", "journey", 1, "page-section"], ["id", "petProjects", 1, "page-section", "bg-dark", "text-white"], ["id", "contact", 1, "page-section", "pb-5"]],
  ...
  function srcAppSectionsContentContactContactComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(ContactComponent, [{
        ...
        key: "getMouseOverMailLinkStyle",
        value: function getMouseOverMailLinkStyle() {
    ...
    ContactComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 27,
      vars: 6,
      consts: [[1, "container"], [1, "row", "justify-content-center"], [1, "col-lg-8", "text-center"], [1, "mt-0"], [1, "divider", "my-4"], [1, "text-muted", "mb-5"], [1, "col-lg-3", "m-auto", "text-center", "mb-5", "pt-lg-0", "pt-5"], [1, "fas", "fa-envelope", "fa-4x", "mb-3", "text-muted", "cursor-pointer", 3, "click"], [1, "col-lg-3", "m-auto", "text-center", "mb-5", "pt-lg-0", "pt-5", 3, "click"], [1, "fab", "fa-twitter", "fa-4x", "mb-3", "text-muted", "cursor-pointer"], [1, "fab", "fa-linkedin-in", "fa-4x", "mb-3", "text-muted", "cursor-pointer"], [1, "fab", "fa-github", "fa-4x", "mb-3", "text-muted", "cursor-pointer"]],
  ...
  function srcAppSectionsStructureFooterFooterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    FooterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 11,
      vars: 6,
      consts: [[1, "bg-light", "pt-5", "pb-5"], [1, "container"], [1, "row", "justify-content-center"], [1, "small", "text-center", "text-muted"], [1, "small", "text-center", "text-muted", 3, "href"], [1, "fab", "fa-github", "ml-2", "text-muted"]],
  ...
  function srcAppSectionsStructureNavbarNavbarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    NavbarComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 26,
      vars: 30,
      consts: [["id", "mainNav", 1, "navbar", "navbar-expand-lg", "navbar-light", "nav-bar-position", "py-3", "top-fixed"], [1, "container"], [1, "navbar-brand", "text-muted", "js-scroll-trigger", "navbar-name", 3, "click"], ["type", "button", 1, "navbar-toggler", "navbar-toggler-right", "white-on-mobile", "bottom-fixed-burger", 3, "click"], [1, "navbar-toggler-icon"], ["id", "navbarResponsive", 1, "collapse", "navbar-collapse"], [1, "navbar-nav", "ml-auto", "my-2", "my-lg-0"], [1, "nav-item"], [1, "nav-link", "js-scroll-trigger", 3, "click"], [1, "nav-item", 3, "click"], [1, "nav-link", "js-scroll-trigger"]],
